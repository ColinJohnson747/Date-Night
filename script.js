$(document).ready(function() {
  ...
  $(".meal-selection").click(function() {
    console.log("Clicked!");
    let mealSearchValue = $("#meal-selected").val();
    console.log("mealSearchValue", mealSearchValue);
    $("#meal-selected").val("");
  ...
  function buildMealURL(mealSearchValue) {
    let mealURL =
      ...
      console.log("buildMealURL -> mealSearchValue", mealSearchValue)
    ...
    $.ajax({
      ...
      $.ajax({
        ...
        let result = ingredients.filter(ingredient => ingredient);
        let mealImg = "<img src=" + thumbnail + ">";

        let cardMeal = $("<div>").addClass("card mealCard");
        let cardImgMeal = $("<div>")
          .addClass("card-image")
          .append(thumbnail);
        console.log(mealImg);
        let cardBodyMeal = $("<div>").addClass(
          "card-content meal-instructions"
        );
        let mealNameEl = $("<h1>")
          .addClass("card-title")
          .text(mealName);
        ...
        cardMeal.append(cardImgMeal, cardBodyMeal);
        $("#meal-recipie").append(cardMeal);
